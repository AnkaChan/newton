...
- Accelerate `SolverVBD` cloth self-contact with tighter sphere and capsule BVH queries (`wp.bvh_query_sphere` / `wp.bvh_query_capsule`). Requires Warp 1.17.0, which is now the minimum supported version.
