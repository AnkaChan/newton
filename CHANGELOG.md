...
- Add `water_tight_soft_rigid` to `Model.collide()` and `CollisionPipeline.collide()` for triangle-owned soft-rigid contact generation with vertex, edge, and face contact records.
