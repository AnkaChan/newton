...
class TestMixedCurriculum(unittest.TestCase):
    def test_require_minimum_residence_and_consecutive_qualified_validation(self):
        ...
        self.assertEqual(
            first, {"stage": 0, "advanced": False, "qualified": True, "stage_epochs": 1, "qualified_epochs": 1}
        )
        ...
        self.assertEqual(
            advanced, {"stage": 1, "advanced": True, "qualified": True, "stage_epochs": 0, "qualified_epochs": 0}
        )
