...
def damp_collision(
    ...
    The gap rate d_dot = sum_j(b_j * dot(n, v_j)) vanishes under rigid
    translation because barycentric weights b_j sum to zero.

    Args:
        gap_rate: Rate of gap change. Negative means gap is closing.
