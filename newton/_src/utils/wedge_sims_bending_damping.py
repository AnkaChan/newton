...
if __name__ == "__main__":
    ...
    loaded_configs = {}
    base_dir_new = r"D:\Data\GTC2025DC_Demo\B1024\bending_damping_longer"
    base_config_path = 'Config/config_b_1026.json'

    wedge_base_name = "sweep_bending_damping"
