...
def _start_ppfcs_streaming(
    ...
    for b, name, _V_world_yup, _F in robot_assets:
        ...
        for t in range(n_frames):
            ...
            quaternions.append(
                np.array([q_xyzw_yup[3], q_xyzw_yup[0], q_xyzw_yup[1], q_xyzw_yup[2]], dtype=np.float64)
            )
...
class Example:
    ...
    def __init__(self, viewer, args):
        ...
        pile_V_zup, pile_F = _read_pile_world_zup() if self._has_pile else (
    ...
    def step(self) -> None:
        ...
        if self._frame_index == 0:
            ...
            jq_record = self._replay_joint_q[
                min(self._frame_index - 1, self._replay_joint_q.shape[0] - 1)
            ]
