...
class Simulator:
    ...
    def finalize(self, fixed_particles=None):
        ...
        self.solver = newton.solvers.SolverVBD(
            ...
            particle_enable_self_contact=cfg("handle_self_contact"),
            particle_self_contact_radius=cfg("self_contact_radius"),
            particle_self_contact_margin=cfg("self_contact_margin"),
            particle_topological_contact_filter_threshold=cfg("topological_contact_filter_threshold"),
            particle_rest_shape_contact_exclusion_radius=cfg("rest_shape_contact_exclusion_radius"),
            particle_enable_tile_solve=cfg("use_tile_solve"),
            particle_vertex_contact_buffer_size=cfg("vertex_collision_buffer_pre_alloc"),
            particle_edge_contact_buffer_size=cfg("edge_collision_buffer_pre_alloc"),
            particle_collision_detection_interval=cfg("collision_detection_interval"),
