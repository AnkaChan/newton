...
###########################################################################
# Example VBD Bag Franka Pickup (Unified Solve Test)
#
...
# two-solver coupling pattern: Featherstone writes the new body_q into
# state_out, then VBD reads state_in.body_q (previous) and
# state_out.body_q (current) for cloth-body contacts.
#
# Command: python -m newton.examples vbd_bag_franka_pickup_unified_test
#
###########################################################################
