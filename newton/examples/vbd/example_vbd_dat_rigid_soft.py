...
#
# With ``rigid_enable_penetration_free=True`` the solver truncates both the
...
PARAMS = {
    ...
    "enable_dat": True,
    # contact query margin; per substep no surface point may move farther than
    # ~0.5 * relaxation * margin, so it must exceed the fastest per-substep motion
...
class Example:
    def __init__(self, viewer, args):
        ...
        self.solver = newton.solvers.SolverVBD(
            ...
            rigid_penetration_free_query_margin=self.params["soft_contact_margin"],
