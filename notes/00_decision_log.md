...
| D7.3 | **Composition in S-space**: S\* = Sₜ + ΔS₀ + Σ Prolongₗ(ΔSₗ), additive, rotation-free; partition-of-unity prolongation over *adjacent* clusters only | parent rotation never passed down; PoU = multires-vbd lesson (blocky piecewise-constant seams) | **PLANNED** |
